...
function DashboardContent() {
  ...
  const artworkIssues = orders.filter((o) => o.artworkStatus === "needs-adjustment").length

  return (
    <DashboardLayout title="My Dashboard" description="Manage your orders and create new ones">
      {showSuccessMessage && (
        <Alert className="mb-6 bg-green-50 border-green-200">
          ...
          <AlertDescription>
            ...
            <p className="text-sm text-green-700">
              Your order has been submitted and is awaiting payment confirmation. Check your email for details.
            </p>
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Artwork Issues</CardTitle>
      ...
      <div className="mb-8">
        <Card className="bg-gradient-to-r from-primary/10 via-primary/5 to-accent/10 border-primary/20">
          <CardHeader>
            <CardTitle>Ready to create a new order?</CardTitle>
            <CardDescription>
              Upload your artwork, choose products, and get your order processed quickly
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button onClick={() => router.push("/dashboard/new-order")} size="lg" className="gap-2">
        ...
        <CardContent>
          {orders.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground mt-2">Get started by creating your first order</p>
              <Button onClick={() => router.push("/dashboard/new-order")} className="mt-4" variant="outline">
                Create Order
              </Button>
            </div>
          ) : (
